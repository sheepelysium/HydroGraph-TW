...
onMounted(() => {
  ...
  nodes.forEach((node) => {
    if (node.lat && node.lon) {
      ...
      node.y = pos.y;
      // 測站固定在地理位置，不受力導向影響
      if (node.group === 'WaterStation' || node.group === 'RainStation') {
        node.fx = pos.x;
        node.fy = pos.y;
      }
    } else {
  ...
  // 繪製台灣地圖輪廓（更準確的座標，順時針從北端開始）
  const taiwanOutlineCoords = [
    // 北部（基隆、台北）
    [121.75, 25.30], [121.80, 25.28], [121.85, 25.23], [121.88, 25.18], [121.90, 25.12],
    [121.92, 25.05], [121.93, 24.98], [121.95, 24.90], [121.96, 24.82], [121.97, 24.75],

    // 東北角（宜蘭）
    [121.98, 24.68], [121.96, 24.60], [121.92, 24.52], [121.88, 24.45], [121.83, 24.38],
    [121.78, 24.32], [121.73, 24.27], [121.68, 24.23], [121.63, 24.20], [121.58, 24.17],

    // 東部（花蓮）
    [121.60, 24.10], [121.62, 24.03], [121.64, 23.96], [121.65, 23.88], [121.66, 23.80],
    [121.67, 23.72], [121.68, 23.64], [121.67, 23.56], [121.65, 23.48], [121.62, 23.40],
    [121.58, 23.32], [121.54, 23.25], [121.50, 23.18], [121.45, 23.12], [121.40, 23.07],

    // 東南部（台東）
    [121.35, 23.02], [121.30, 22.98], [121.25, 22.95], [121.20, 22.92], [121.15, 22.88],
    [121.10, 22.83], [121.05, 22.77], [121.00, 22.70], [120.95, 22.63], [120.90, 22.55],

    // 南端（屏東、恆春）
    [120.85, 22.48], [120.80, 22.42], [120.75, 22.38], [120.70, 22.35], [120.65, 22.33],
    [120.60, 22.32], [120.55, 22.33], [120.50, 22.35], [120.45, 22.38], [120.40, 22.42],
    [120.35, 22.47], [120.30, 22.53], [120.25, 22.60], [120.20, 22.68], [120.17, 22.77],

    // 西南部（高雄、台南）
    [120.15, 22.85], [120.13, 22.93], [120.12, 23.01], [120.11, 23.09], [120.10, 23.17],
    [120.09, 23.25], [120.08, 23.33], [120.07, 23.41], [120.06, 23.49], [120.06, 23.57],

    // 中西部（嘉義、彰化）
    [120.07, 23.65], [120.08, 23.73], [120.10, 23.80], [120.12, 23.87], [120.15, 23.94],
    [120.18, 24.01], [120.22, 24.08], [120.26, 24.15], [120.30, 24.22], [120.35, 24.28],

    // 西北部（苗栗、新竹）
    [120.40, 24.34], [120.46, 24.40], [120.52, 24.46], [120.58, 24.52], [120.65, 24.58],
    [120.72, 24.64], [120.79, 24.70], [120.86, 24.76], [120.93, 24.82], [121.00, 24.88],

    // 北部（桃園、台北）
    [121.07, 24.93], [121.14, 24.98], [121.21, 25.02], [121.28, 25.06], [121.35, 25.10],
    [121.42, 25.13], [121.49, 25.16], [121.56, 25.19], [121.63, 25.23], [121.70, 25.27]
  ];
